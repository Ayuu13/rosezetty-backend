...
const JenisProduk = sequelize.define(
	'jenisproduk',
	{
		id: {
			type: DataTypes.INTEGER,
...
const SistemBayar = sequelize.define(
	'sistembayar',
	{
		id: {
			type: DataTypes.INTEGER,
...
const ProdukVersi = sequelize.define(
	'versiproduk',
	{
		id: {
			type: DataTypes.INTEGER,
...
const MetodeBayar = sequelize.define(
	'metodebayar',
	{
		id: {
			type: DataTypes.INTEGER,
...
PesananDetail.belongsTo(ProdukVersi, {
	as: 'produkVersi',
	foreignKey: 'versiproduk_id',
});
ProdukVersi.hasMany(PesananDetail, {
	as: 'pesanandetail',
	foreignKey: 'versiproduk_id',
});
